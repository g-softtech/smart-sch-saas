...
describe("AcademicsService (Unit / Mocked)", () => {
  ...
  describe("Campus", () => {
    it("valid Campus creation", async () => {
      ...
      const result = await service.createCampus("tenant-1", {
        schoolId: "school-1",
        name: "Main Campus",
      });
  ...
  describe("Class", () => {
    it("valid Class", async () => {
      ...
      const result = await service.createClass("tenant-1", {
        schoolId: "school-1",
        name: "Year 1",
      });
  ...
  describe("Arm", () => {
    it("valid Arm", async () => {
      ...
      repo.findCampus.mockResolvedValueOnce({
        id: "campus-1",
        schoolId: "school-1",
        tenantId: "tenant-1",
      } as any);
  ...
  describe("Subject", () => {
    it("valid Subject without SubjectGroup", async () => {
      ...
      await expect(
        service.createSubject("tenant-1", {
          schoolId: "school-1",
          name: "Math",
        }),
      ).resolves.toBeDefined();
    ...
    it("valid Subject with matching SubjectGroup", async () => {
      ...
      repo.findSubjectGroup.mockResolvedValueOnce({
        id: "group-1",
        schoolId: "school-1",
        tenantId: "tenant-1",
      } as any);
  ...
  describe("Queries", () => {
    it("listCampuses proxies to repo with tenantId", async () => {
      ...
      expect(repo.listCampuses).toHaveBeenCalledWith(
        "tenant-1",
        "school-1",
        0,
        50,
    ...
    it("listSubjectGroups proxies to repo with tenantId", async () => {
      ...
      const result = await service.listSubjectGroups(
        "tenant-1",
        "school-1",
        0,
        50,
      ...
      expect(repo.listSubjectGroups).toHaveBeenCalledWith(
        "tenant-1",
        "school-1",
        0,
        50,
