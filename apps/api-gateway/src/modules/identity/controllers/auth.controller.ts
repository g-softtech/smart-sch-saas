...
export class AuthController {
  ...
  async register(@Body() dto: RegisterUserDto): Promise<ApiResponseDto<{ accessToken: string }>> {
  ...
  async login(@Body() dto: LoginDto): Promise<ApiResponseDto<{ accessToken: string }>> {
