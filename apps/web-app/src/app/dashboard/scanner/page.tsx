...
type ScanSource = "EXTERNAL" | "CAMERA" | "MANUAL";
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto min-h-[80vh] flex flex-col" onClick={maintainFocus}>
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className={`bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col items-center justify-center min-h-[400px] ${source === "MANUAL" ? "md:col-span-2 max-w-2xl mx-auto w-full" : ""}`}>
          {source === "MANUAL" ? (
            <ManualScanner operationMode={operationMode} />
          ) : source === "EXTERNAL" ? (
