          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400">ID Card Management</h3>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Issue or revoke QR credentials</p>
                </div>
              </div>
