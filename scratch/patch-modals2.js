...
if (lastDivIndex !== -1 && !content.includes('isCreateCampusModalOpen && (')) {
  content = content.slice(0, lastDivIndex) + modalInjections + content.slice(lastDivIndex);
  fs.writeFileSync(filePath, content, 'utf8');
  console.log('Modals injected using lastIndexOf!');
} else {
  console.log('Failed to find injection point or already injected.');
}
